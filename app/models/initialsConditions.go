...
var CeleryEmailsToSend = []string{"celeryEmail1@mail.ru", "celeryEmail2@mail.ru"}

var StartedMailsForBasicSending = []string{"first@mail.ru", "second@mail.ru", "third@mail.ru"}
